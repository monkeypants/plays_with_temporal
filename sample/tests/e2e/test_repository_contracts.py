...
class TestMinioPaymentRepositoryContract:
    ...
    @pytest.mark.asyncio
    async def test_process_payment_success(self, payment_repo, sample_order):
    ...
    @pytest.mark.asyncio
    async def test_get_payment_existing(self, payment_repo, sample_order):
    ...
    @pytest.mark.asyncio
    async def test_get_payment_nonexistent(self, payment_repo):
        """Test retrieving a non-existent payment."""
        payment = await payment_repo.get_payment("nonexistent-payment-id")
        assert payment is None

    @pytest.mark.asyncio
    async def test_payment_repository_idempotency(self, payment_repo):
