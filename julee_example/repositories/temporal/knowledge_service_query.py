"""
Temporal activity wrapper and workflow proxy for knowledge service query
repository.

This module contains:
1. The @temporal_activity_registration decorated class that wraps the pure
   backend MinioKnowledgeServiceQueryRepository as Temporal activities
   (for worker use only)
...
julee.knowledge_service_query_repo.minio.{method}
"""
