"""
Temporal activity wrapper and workflow proxy for knowledge service config
repository.

This module contains:
1. The @temporal_activity_registration decorated class that wraps the pure
   backend MinioKnowledgeServiceConfigRepository as Temporal activities
   (for worker use only)
...
julee.knowledge_service_config_repo.minio.{method}
"""
